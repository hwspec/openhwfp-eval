...
/** Connor's original hardcoded generator. Superseded by GenerateAllTestModules, which reads
  * generated/elaboration_plan.json instead of naming all 71 designs inline.
  *
  * Kept as the reference for what the descriptors are supposed to reproduce. Delete after the
  * paper ships.
  *
  *   sbt "runMain Generate.GenerateAllTestModulesLegacy"
  */
object GenerateAllTestModulesLegacy extends App {
